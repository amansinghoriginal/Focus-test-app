...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Sun Mar 25 22:55:45 2012
# Project:  focus.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/default -I. -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include/QtDBus -I/usr/include -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/focus1.0.0/ && $(COPY_FILE) --parents focus.cpp .tmp/focus1.0.0/ && (cd `dirname .tmp/focus1.0.0` && $(TAR) focus1.0.0.tar focus1.0.0 && $(COMPRESS) focus1.0.0.tar) && $(MOVE) `dirname .tmp/focus1.0.0`/focus1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/focus1.0.0
