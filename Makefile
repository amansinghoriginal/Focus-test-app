...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Mon Mar 26 21:56:49 2012
# Project:  focus.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/default -I. -I/usr/include/QtCore -I/usr/include/QtDBus -I/usr/include -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
SOURCES       = main.cpp \
		focus.cpp \
		dbusconnection.cpp moc_dbusconnection.cpp
OBJECTS       = main.o \
		focus.o \
		dbusconnection.o \
		moc_dbusconnection.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/focus1.0.0/ && $(COPY_FILE) --parents dbusconnection.h focus.h .tmp/focus1.0.0/ && $(COPY_FILE) --parents main.cpp focus.cpp dbusconnection.cpp .tmp/focus1.0.0/ && (cd `dirname .tmp/focus1.0.0` && $(TAR) focus1.0.0.tar focus1.0.0 && $(COMPRESS) focus1.0.0.tar) && $(MOVE) `dirname .tmp/focus1.0.0`/focus1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/focus1.0.0
...
compiler_moc_header_make_all: moc_dbusconnection.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dbusconnection.cpp
moc_dbusconnection.cpp: dbusconnection.h
	/usr/bin/moc $(DEFINES) $(INCPATH) dbusconnection.h -o moc_dbusconnection.cpp
...
moc_dbusconnection.o: moc_dbusconnection.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_dbusconnection.o moc_dbusconnection.cpp
